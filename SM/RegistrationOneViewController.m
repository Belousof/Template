...
@implementation RegistrationOneViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    }
    {
        ...
        [wrapper addSubview:main];
        {
            ...
            [buttonStart setTitle:@"Зарегистрировать телефон" forState:UIControlStateNormal];
...
-(void)tappedStart{
    RegistrationTwoViewController *reg = [[RegistrationTwoViewController alloc] init];
