...
#import "RegistrationTwoViewController.h"

@implementation RegistrationTwoViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)tappedStart{
    RegistrationThreeViewController *reg = [[RegistrationThreeViewController alloc] init];
